...
class InformationControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create information" do
    assert_difference('Information.count') do
      post information_index_url, params: { information: { address: @information.address, email: @information.email, telephone: @information.telephone, type: @information.type } }
    end
  ...
  test "should update information" do
    patch information_url(@information), params: { information: { address: @information.address, email: @information.email, telephone: @information.telephone, type: @information.type } }
